...
const Index = () => {
  return (
    ...
    <link href="https://fonts.googleapis.com/css2?family=Forum&display=swap" rel="stylesheet"></link>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div className="service-card flex flex-col h-full">
              <div className="h-16 w-16 flex items-center justify-center rounded-full bg-eaststreet-lightest mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-eaststreet-darkest">
      ...
      <section className="bg-eaststreet-darkest text-white py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-4xl md:text-5xl font-bold font-serif text-eaststreet-primary mb-2">50+</p>
            ...
            <div>
              <p className="text-4xl md:text-5xl font-bold font-serif text-eaststreet-primary mb-2">25</p>
