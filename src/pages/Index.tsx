...
const Index = () => {
  return (
    ...
    <link href="https://fonts.googleapis.com/css2?family=Forum&display=swap" rel="stylesheet"></link>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            {/* Service Card 1 */}
            <div className="service-card flex flex-col h-full bg-eaststreet-lightest">
      ...
      {/* Stats Section - Updated colors: light blue background with dark blue text */}
      <section className="bg-eaststreet-lightest py-16">
        <div className="container mx-auto px-4 md:px-6">
