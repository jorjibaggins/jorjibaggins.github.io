      ...
      <main className="min-h-screen bg-eaststreet-lightest">
        <div className="container mx-auto px-4 md:px-6 py-20">
          <div className="text-center">
            <h1 className="text-4xl font-serif text-eaststreet-darkest mb-4">Article Not Found</h1>
            <p className="text-eaststreet-dark mb-8">The article you're looking for doesn't exist.</p>
  ...
  const formatContent = (content: string) => {
    ...
    lines.forEach((line, index) => {
      ...
      if (trimmedLine.startsWith('# ')) {
        ...
        // Empty lines create spacing but don't flush lists immediately
        if (!inList) {
