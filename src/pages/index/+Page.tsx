        ...
        <section className="bg-eaststreet-lightest py-12">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-xs opacity-60 leading-relaxed max-w-6xl mx-auto">
              <p className="mb-3">
                Singapore's leading business broker Singapore, East Street Advisory specializes in comprehensive M&A advisory and company valuation services that deliver results. We're recognized as the best business broker Singapore for SME owners, with over S$2B in successfully closed transactions across 25+ industries.
              </p>
              <p className="mb-3">
