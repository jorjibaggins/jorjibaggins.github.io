      ...
      <section className="bg-eaststreet-beige py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl text-eaststreet-brown mb-6 font-serif">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="service-card">
              ...
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">Understand Your True Worth</h3>
            ...
            <div className="service-card">
              ...
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">Make Strategic Decisions</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="service-card">
              ...
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">Strengthen Your Position</h3>
              <p className="text-eaststreet-gray">
          ...
          <div className="max-w-4xl mx-auto mt-12">
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2 font-serif">Initial Consultation</h3>
                  <p className="text-eaststreet-gray">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2 font-serif">Financial Analysis</h3>
                  <p className="text-eaststreet-gray">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2 font-serif">Market Assessment</h3>
                  <p className="text-eaststreet-gray">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2 font-serif">Valuation Report</h3>
                  <p className="text-eaststreet-gray">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-5xl mx-auto">
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">How long does a business valuation take?</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">Is the valuation really free?</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">What information will you need from me?</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3 font-serif">How confidential is this process?</h3>
              <p className="text-eaststreet-gray">
