...
const Valuation = () => {
  return (
    <main className="min-h-screen pt-32">
      {/* Hero Section */}
      <section className="bg-eaststreet-beige py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl text-eaststreet-brown mb-6" style={{ fontFamily: 'Forum, serif' }}>
                Thinking of Selling Your Business?
              </h1>
              <p className="text-xl text-eaststreet-gray mb-8">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="service-card">
              <div className="mb-4 h-12 w-12 flex items-center justify-center rounded-full bg-eaststreet-beige">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-eaststreet-brown">
            ...
            <div className="service-card">
              ...
              <h3 className="text-xl text-eaststreet-brown mb-3" style={{ fontFamily: 'Forum, serif' }}>Make Strategic Decisions</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="service-card">
              ...
              <h3 className="text-xl text-eaststreet-brown mb-3" style={{ fontFamily: 'Forum, serif' }}>Strengthen Your Position</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-eaststreet-brown text-white flex items-center justify-center text-lg font-bold">1</div>
                </div>
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2" style={{ fontFamily: 'Forum, serif' }}>Initial Consultation</h3>
                  <p className="text-eaststreet-gray">
              ...
              <div className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-eaststreet-brown text-white flex items-center justify-center text-lg font-bold">2</div>
                </div>
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2" style={{ fontFamily: 'Forum, serif' }}>Financial Analysis</h3>
                  <p className="text-eaststreet-gray">
              ...
              <div className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-eaststreet-brown text-white flex items-center justify-center text-lg font-bold">3</div>
                </div>
                <div>
              ...
              <div className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-eaststreet-brown text-white flex items-center justify-center text-lg font-bold">4</div>
                </div>
                <div>
                  <h3 className="text-xl text-eaststreet-brown mb-2" style={{ fontFamily: 'Forum, serif' }}>Valuation Report</h3>
                  <p className="text-eaststreet-gray">
      ...
      <section id="valuation-form" className="py-16 bg-eaststreet-beige scroll-mt-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <SectionHeading title="Get Your Free Business Valuation" centered={true} />
            <p className="text-center text-eaststreet-gray mb-10 max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-5xl mx-auto">
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3" style={{ fontFamily: 'Forum, serif' }}>How long does a business valuation take?</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3" style={{ fontFamily: 'Forum, serif' }}>Is the valuation really free?</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3" style={{ fontFamily: 'Forum, serif' }}>What information will you need from me?</h3>
              <p className="text-eaststreet-gray">
            ...
            <div className="bg-eaststreet-cream p-6 rounded-lg">
              <h3 className="text-xl text-eaststreet-brown mb-3" style={{ fontFamily: 'Forum, serif' }}>How confidential is this process?</h3>
              <p className="text-eaststreet-gray">
